...
public class jal extends animation{
    
    public jal(home bahaa) {
        super(bahaa);
    }
   ...
   wire8.setForeground(Color.red);
    ...
    wire10.setText("1");
    wire10.setForeground(Color.green);
    ...
    //wire11.setText("1");
    wire11.setForeground(Color.orange);
...
//    wire19.setText((printPc()+4)+"");
    ...
    //wire20.setText("Jump Address");
    wire20.setBounds(700, 0, 300, 30);
    ...
    wire34.setForeground(Color.red);
     ...
     wire38.setText("immed in 16 bits(not used)");
    ...
    wire39.setText("val in rt(not used)");
