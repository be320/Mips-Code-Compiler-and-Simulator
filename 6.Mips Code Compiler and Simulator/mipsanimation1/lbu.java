...
public class lbu extends animation{
    
    public lbu(home bahaa) {
        super(bahaa);
    }
...
//    wire15.setText((printPc()+4)+"");
    ...
    wire16.setForeground(Color.orange.darker().darker());
