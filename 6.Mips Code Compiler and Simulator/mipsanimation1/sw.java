...
public class sw extends animation{
    
    public sw(home bahaa) {
        super(bahaa);
    }
   ...
   wire4.setText("X");
   wire4.setForeground(new Color(255,128,0));
   
   g.setColor(Color.green);
   g.drawLine(477, 225, 880, 225);//5
   g.drawLine(880, 225, 880, 300);//5_1
   wire5.setText("1");
   wire5.setForeground(Color.green);
   ...
   wire7.setText("1");
   wire7.setForeground(Color.green);
...
//    wire13.setText(printPc()+"");
    ...
    g.setColor(new Color(193, 140, 255));
    g.drawLine(200, 50, 260, 50);//14
    g.fillPolygon(x7, y7, na);//14_1
    wire14.setText("4");
    wire14.setForeground(new Color(193, 140, 255));
...
//    wire21.setText((printPc()+4)+"");
    wire21.setForeground(Color.yellow);
   ...
   // wire27.setText("val in rt");
    wire27.setForeground(new Color(249, 73, 42));
    ...
    //wire28.setText("val in rs+i");
    wire28.setForeground(new Color(249, 73, 42));
    ...
    wire30.setText("00101011");
    wire30.setForeground(Color.green);
    ...
    wire31.setText("X");
    wire31.setForeground(new Color(255,128,0)); //Default Colour For Don'tCare
    
    g.setColor(new Color(249, 73, 42));
    g.drawLine(380, 340, 380, 320);//32
    g.drawLine(380, 340, 390, 340);//32_1
    //wire32.setText("rt");
    wire32.setForeground(new Color(249, 73, 42));
    ...
    wire34.setForeground(new Color(249, 182, 107));
     ...
     //wire37.setText("rt/rd");
     wire37.setForeground(new Color(249, 73, 42));

     
     g.setColor(new Color(255, 48, 203));
     g.drawLine(360, 470, 490, 470);//38
     //wire38.setText("i(16 bits)");
    ...
    wire39.setForeground(new Color(249, 73, 42));
    
    g.setColor(new Color(255, 48, 203));
    g.drawLine(560, 470, 590, 470);//40
    g.drawLine(590, 470, 590, 130);//40_1
    g.drawLine(590, 130, 600, 130);//40_2
    wire40.setText("i(32 bits)");
    wire40.setForeground(new Color(255, 48, 203));
    
    g.setColor(new Color(255, 48, 203));
    g.drawLine(590, 370, 630, 370);//41
    //wire41.setText("i(32 bits)");
    wire41.setForeground(new Color(255, 48, 203));
    
    g.drawLine(650, 370, 710, 370);//42
    //wire42.setText("i(32 bits)");
