...
public class animation extends JPanel {
    ...
    private JLabel clkcounter= new JLabel ("Instruction Counter = ");
    private JLabel clkcounter1= new JLabel ("1");
    private JLabel clktxt= new JLabel ("Clock Cycles = ");
    private JLabel clkvalue= new JLabel ("1");
//     private static int regcounter;
    ...
    protected JLabel mainn=new JLabel();
...
//     regarr=printReg();   
        ...
        wire16.setBounds(680, 102, 70, 70);
        ...
        wire20.setBounds(450,30, 250, 70);
        ...
        wire22.setBounds(930, 315, 60, 60);
        ...
        wire27.setBounds(575, 300, 70, 70);
        ...
        wire32.setBounds(375, 292, 70, 70);
        ...
        wire40.setBounds(525, 100, 250, 70);
...
//         pcvalue=printPc();
        ...
        this.setLayout(null);
//    insarr=insarr();
clkcounter.setBounds(550, 600, 250, 50);
...
clkcounter1.setBounds(780, 600, 100, 50);
 clkcounter1.setText((count+1)+"");
     this.add(clkcounter);
     this.add(clkcounter1);
clktxt.setBounds(300, 600, 250, 50);
clktxt.setFont(clkcounter.getFont().deriveFont(20.0f));
clkvalue.setFont(clkcounter.getFont().deriveFont(20.0f));
clktxt.setForeground(Color.YELLOW);
clkvalue.setForeground(new Color(42, 255, 0));
clkvalue.setBounds(470, 600, 100, 50);
 clkvalue.setText(nextcount+"");
     this.add(clktxt);
     this.add(clkvalue);
  mainn.setBounds(30, 400, 300, 100);
mainn.setFont(clkcounter.getFont().deriveFont(15.0f));
mainn.setForeground(new Color(42, 255, 0));
this.add(mainn);
