...
public class nor extends animation{
    
    public nor(home bahaa) {
        super(bahaa);
    }
...
//    wire21.setText((printPc()+4)+"");
   ...
   // wire23.setText("val in ALU");
    wire23.setForeground(Color.LIGHT_GRAY);
    ...
    //wire24.setText("val in ALU");
    wire24.setForeground(Color.LIGHT_GRAY);
    
    g.setColor(Color.blue);
    g.drawLine(716, 500, 760, 500);//25
    g.drawLine(760, 500, 760, 380);//25_1
    //wire25.setText("0001");
    wire25.setForeground(Color.blue);
  ...
  //  wire32.setText("rt");
   ...
   //  wire34.setText("rs");
    ...
    // wire36.setText("rd");
     wire36.setForeground(Color.WHITE);
     
     g.setColor(Color.WHITE);
     g.drawLine(410, 350, 470, 350);//37
   //  wire37.setText("rd");
     wire37.setForeground(Color.WHITE);
   ...
   // wire39.setText("val in ALU");
    wire39.setForeground(Color.LIGHT_GRAY);
    ...
    //wire42.setText("value in rd");
    wire42.setForeground(Color.WHITE);
    
    g.setColor(Color.red);
    g.drawLine(360, 520, 650, 520);//43
    //wire43.setText("000000");
