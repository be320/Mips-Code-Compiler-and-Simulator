...
wire15.setForeground(Color.orange);
g.setColor(Color.red);
...
wire23.setForeground(Color.white);
...
wire24.setForeground(Color.white);
g.setColor(Color.green);
...
wire27.setForeground(new Color(249, 182, 107));
...
wire28.setForeground(new Color(249, 182, 107));
g.setColor(Color.yellow);
...
wire39.setForeground(Color.orange.darker());
g.setColor(Color.red);
