// YELLOW FOR WORKING ....RED FOR NOT WORKING ...GREEN FOR CONTROLS SIGNALS
...
public class lw extends animation{
   ...
   wire3.setText("1");
   wire3.setForeground(Color.green);
   ...
   wire8.setText("1");
   wire8.setForeground(Color.green);
...
//    wire21.setText((printPc()+4)+"");
    ...
    //wire22.setText("used");
    wire22.setForeground(Color.YELLOW);

    g.setColor(Color.YELLOW);
    g.drawLine(790, 360, 850, 360);//23
    //wire23.setText("rs+signex");
    wire23.setForeground(Color.YELLOW);
   ...
   // wire25.setText("0010");
    ...
    wire26.setForeground(Color.YELLOW);
...
//     wire37.setText("rt");
     ...
     //wire38.setText("immed in 16bits");
     wire38.setForeground(Color.YELLOW);
    ...
    //wire39.setText("used");
    wire39.setForeground(Color.YELLOW);
    ...
    wire40.setForeground(Color.BLUE);

    g.setColor(Color.YELLOW);
    g.drawLine(590, 370, 630, 370);//41
    //wire41.setText("immed in 32bits");
    wire41.setForeground(Color.YELLOW);

    g.drawLine(650, 370, 710, 370);//42
    //wire42.setText("immed in 32bits");
    wire42.setForeground(Color.YELLOW);
