...
public class j extends animation{
   ...
   // wire13.setText(printPc()+"");
    ...
    wire17.setText("0");
    wire17.setForeground(Color.red);
    ...
    wire19.setText("Not Used");
    wire19.setForeground(Color.red);
   ...
   // wire20.setText((printPc()+4)+"");
    wire20.setForeground(Color.magenta);
    
    g.setColor(Color.yellow);
    g.drawLine(500, 95, 500, 50);//21
    g.fillPolygon(x15, y15, na);//21_1
    //wire21.setText((printPc()+4)+000010+"");
    ...
    wire26.setText("Not Used");
    wire26.setForeground(Color.red);
    ...
    g.setColor(new Color(170, 86, 109));
    g.drawLine(350, 360, 350, 50);//29
    g.drawLine(350, 50, 400, 50);//29_1
    //wire29.setText(printPc()+"");
    wire29.setForeground(new Color(170, 86, 109));
    
    g.setColor(Color.GREEN);
    g.drawLine(360, 200, 360, 520);//30
    g.drawLine(360, 200, 400, 200);//30_1
   // wire30.setText("Not Used");
    ...
    //wire33.setText(printPc()*4+"");
    wire33.setForeground(new Color(170, 86, 109));
    
    g.setColor(Color.red);
     g.drawLine(360, 300, 470, 300);//34
     wire34.setText("Not Used");
