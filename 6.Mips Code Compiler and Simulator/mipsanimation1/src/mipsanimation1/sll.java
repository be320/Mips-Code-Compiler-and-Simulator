 ...
 * @author dell
 */
public class sll extends animation{
    protected JLabel wiresll=new JLabel("");
    public sll(home bahaa) {
        super(bahaa);
    }
...
g.setColor(Color.green);
wiresll.setBounds(500, 550, 100, 50);
wiresll.setForeground(Color.green);
this.add(wiresll);
 g.drawLine(360, 520, 360, 560);//sll1
 g.drawLine(360, 560, 780, 560);//sll2
 g.drawLine(780, 370, 780, 560);//sll3
g.drawLine(360, 200, 360, 520);//30
g.drawLine(360, 200, 400, 200);//30_1
wire30.setText("000000");
...
//wire36.setText("rd");
wire36.setForeground(new Color(249, 73, 42));
g.setColor(new Color(249, 73, 42));
...
wire39.setForeground(new Color(249, 182, 107));
g.setColor(Color.red);
...
wire42.setForeground(new Color(249, 182, 107));
g.setColor(Color.yellow);
g.drawLine(360, 520, 650, 520);//43
wire43.setText("100000");
wire43.setForeground(Color.yellow);
}}
//public JTextField [] memarr(){
//return m.getTxtaddress();
//}
//public JTextField [] memArr(){
//return m.getTxtval();
//}
