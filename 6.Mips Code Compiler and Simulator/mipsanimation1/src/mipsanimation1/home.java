...
public class home extends JFrame {
    ...
    private int[] binary26;
    private int[] binary16;
    private memory kiro = new memory();
    private rf hi[]=new rf[1000];
    ...
    protected window w[]=new window[1000];
    ...
    public void show(int j) {
        ...
        if (fekra[j].getInst().equals("add")) {
            ...
            fekra[j].getDraw().wire29.setText("100000");
      ...
      fekra[j].getDraw().mainn.setText("000000"+"  "+fekra[j].getRs().getId()+"  "+
              fekra[j].getRt().getId()+"  "+fekra[j].getRd().getId()+"  "+"00000"+"  "+"100000");
        }
                ...
                fekra[j].getDraw().wire42.setText(fekra[j].getRt().getValue() + "");
                fekra[j].getDraw().wire43.setText("100111");
                 fekra[j].getDraw().wire25.setText("1100");
                ...
                fekra[j].getRd().setValue(n);
                 fekra[j].getDraw().mainn.setText("100111"+"  "+fekra[j].getRs().getId()+"  "+
              fekra[j].getRt().getId()+"  "+fekra[j].getRd().getId()+"  "+"00000"+"  "+"000000");
            }
  ...
  fekra[j].getDraw().mainn.setText("000000"+"  "+fekra[j].getRs().getId()+"  "+
              fekra[j].getRt().getId()+"  "+fekra[j].getRd().getId()+"  "+"00000"+"  "+"101010");
            }
        ...
        if (fekra[j].getInst().equals("j")) {
            ...
            binary26=convertbin((intpc + (go * 4))/4);
            binary4 = convertbin(pcValue + 4);
            binary28 = convertbin((intpc + (go * 4)));
            fekra[j].getDraw().wire30.setText("000010");
            ...
            fekra[j].getDraw().mainn.setText("000010"+"  "+prnt26(binary26));
        }
            ...
            fekra[j].getDraw().mainn.setText("000100"+"  "+prnt26(binary26));
            ...
            binary16=convertbin(((intpc + (4 * go)) - (fekra[j].getMypc() + 4)) / 4);
            ...
            fekra[j].getDraw().wire32.setText("000100");
            fekra[j].getDraw().wire37.setText(fekra[j].getRd().getId());
            fekra[j].getDraw().wire26.setText(fekra[j].getRs().getValue() + "");
            ...
            fekra[j].getDraw().mainn.setText("000100"+"  "+fekra[j].getRs().getId()+"  "+fekra[j].getRd().getId()+"  "+
                  prnt16(binary16)  );
            ...
            fekra[j].getDraw().wire15.setText((fekra[j].getMypc() + 4) + "");
            fekra[j].getDraw().wire19.setText((fekra[j].getMypc() + 4) + "");
            fekra[j].getDraw().wire17.setText((fekra[j].getMypc() + 4) + "");
            fekra[j].getDraw().wire12.setText(fekra[j].getMypc() + "");
            fekra[j].getDraw().wire34.setText(fekra[j].getRs().getId());
            fekra[j].getDraw().wire35.setText(fekra[j].getRt().getId());
            fekra[j].getDraw().wire32.setText(fekra[j].getRt().getId());
            ...
            binary16=convertbin(fekra[j].getImmed());
            ...
            fekra[j].getDraw().mainn.setText("001000"+"  "+fekra[j].getRs().getId()+"  "+fekra[j].getRt().getId()+"  "+
                   prnt16(binary16) );
            ...
            binary16=convertbin(fekra[j].getImmed());
            fekra[j].getDraw().wire34.setText(fekra[j].getRs().getId());
            fekra[j].getDraw().wire30.setText("100011");
            fekra[j].getDraw().wire25.setText("00");
            fekra[j].getDraw().wire15.setText((fekra[j].getMypc()+ 4) + "");
            fekra[j].getDraw().wire19.setText((fekra[j].getMypc()+ 4) + "");
            fekra[j].getDraw().wire17.setText((fekra[j].getMypc()+ 4) + "");
            ...
            addresscount++;
            fekra[j].getDraw().mainn.setText("100011"+"  "+fekra[j].getRs().getId()+"  "+fekra[j].getRt().getId()+"  "+
                   prnt16(binary16) );
            ...
            fekra[j].getDraw().wire28.setText(fekra[j].getRt().getValue() + "");
            addresscount++;
            fekra[j].getDraw().mainn.setText("101011"+"  "+fekra[j].getRs().getId()+"  "+fekra[j].getRt().getId()+"  "+
                   prnt16(binary16) );
            ...
            addresscount++;
            fekra[j].getDraw().mainn.setText("100000"+"  "+fekra[j].getRs().getId()+"  "+fekra[j].getRt().getId()+"  "+
                   prnt16(binary16) );
            ...
            fekra[j].getDraw().wire11.setText((pcValue + 4) + "");
            fekra[j].getDraw().wire15.setText((pcValue + 4) + "");
            fekra[j].getDraw().wire19.setText((pcValue + 4) + "");
            fekra[j].getDraw().wire17.setText((pcValue + 4) + "");
            binary16=convertbin(fekra[j].getImmed());
            address[addresscount] = fekra[j].getRs().getValue() + fekra[j].getImmed();
            value[addresscount] = kiro.load(address[addresscount]);
            String s = binarycutter(convertbin(value[addresscount]), fekra[j].getImmed());
            ...
            addresscount++;
fekra[j].getDraw().mainn.setText("100100"+"  "+fekra[j].getRs().getId()+"  "+fekra[j].getRt().getId()+"  "+
                   prnt16(binary16) );
            ...
            fekra[j].getDraw().wire27.setText(fekra[j].getRt().getValue() + "");
            fekra[j].getDraw().wire28.setText(fekra[j].getRt().getValue() + "");
            fekra[j].getDraw().wire30.setText("101000");
            fekra[j].getDraw().wire19.setText((pcValue + 4) + "");
            fekra[j].getDraw().wire15.setText((pcValue + 4) + "");
            fekra[j].getDraw().wire17.setText((pcValue + 4) + "");
            fekra[j].getDraw().wire25.setText("00");
            addresscount++;
            fekra[j].getDraw().mainn.setText("101000"+"  "+fekra[j].getRs().getId()+"  "+fekra[j].getRt().getId()+"  "+
                   prnt16(binary16) );
            ...
            binary16=convertbin(fekra[j].getImmed());
            fekra[j].getDraw().wire12.setText(pcValue + "");
            fekra[j].getDraw().wire13.setText(pcValue + "");
            fekra[j].getDraw().wire15.setText((pcValue +4)+ "");
            fekra[j].getDraw().wire19.setText((pcValue +4)+ "");
            fekra[j].getDraw().wire17.setText((pcValue +4)+ "");
            fekra[j].getDraw().wire11.setText((pcValue + 4) + "");
            ...
            if (fekra[j].getRs().getValue() < Integer.parseInt(fekra[j].getImmed() + "")) {
             ...
             fekra[j].getDraw().mainn.setText("001010"+"  "+fekra[j].getRs().getId()+"  "+fekra[j].getRt().getId()+"  "+
                   prnt16(binary16) );
        } else if (fekra[j].getInst().equals("sll")) {
            obsll[drawcount] = new sll(this);
            fekra[j].setDraw(obsll[drawcount]);
             binary16=convertbin(fekra[j].getImmed());
            fekra[j].getDraw().wire12.setText(pcValue + "");
            fekra[j].getDraw().wire11.setText((pcValue + 4) + "");
            fekra[j].getDraw().wire34.setText(fekra[j].getRs().getId());
            ...
            fekra[j].getDraw().wire19.setText((pcValue + 4) + "");
            fekra[j].getDraw().wire17.setText((pcValue + 4) + "");
            fekra[j].getDraw().wire23.setText(fekra[j].getRs().getValue() * 2 * fekra[j].getImmed() +""); 
            fekra[j].getDraw().wire24.setText(fekra[j].getRs().getValue() * 2 * fekra[j].getImmed() +""); 
            fekra[j].getDraw().wire39.setText(fekra[j].getRs().getValue() * 2 * fekra[j].getImmed() +""); 
            fekra[j].getDraw().wire36.setText(fekra[j].getRt().getId());
            fekra[j].getDraw().wire32.setText("xxxxx");
            fekra[j].getDraw().wire35.setText("xxxxx");
            fekra[j].getDraw().wire37.setText(fekra[j].getRt().getId());
            fekra[j].getDraw().wire26.setText(fekra[j].getRs().getValue() + "");
            fekra[j].getDraw().wire41.setText(fekra[j].getImmed() + "");
            fekra[j].getDraw().wire38.setText(fekra[j].getImmed() + "");
            obsll[drawcount].wiresll.setText(fekra[j].getImmed() + "");
            fekra[j].getRt().setValue(fekra[j].getRs().getValue() * 2 * fekra[j].getImmed());
             fekra[j].getDraw().mainn.setText("000000"+"  "+fekra[j].getRs().getId()+"  "+"xxxxx"+"  "+fekra[j].getRt().getId()+"  "+
                   prnt5(binary16)+"000000" );
        } else if (fekra[j].getInst().equals("jr")) {
            objr[drawcount] = new jr(this);
            fekra[j].setDraw(objr[drawcount]);
            ...
            fekra[j].getDraw().mainn.setText("000000"+"  "+fekra[j].getRs().getId()+"  "+"xxxxx"+"  "+"xxxxx"+"  "+
                   "00000"+"001000" );
 
        }
        else {
            window w=new window(fadya);
            w.setVisible(true);
        }
        if(windowcount>0)
        {w[windowcount-1].dispose();
        hi[windowcount-1].dispose();}
        w[windowcount] = new window(fekra[j].getDraw());
        w[windowcount].setUndecorated(true);
        w[windowcount].setVisible(true);
        hi[windowcount] = new rf(r);
        hi[windowcount].setUndecorated(true);
        hi[windowcount].setVisible(true);
        drawcount++;
        windowcount++;
    }
