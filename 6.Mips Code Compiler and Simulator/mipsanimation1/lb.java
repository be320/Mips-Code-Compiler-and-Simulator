...
public class lb extends animation{
    
    public lb(home bahaa) {
        super(bahaa);
    }
...
//    wire13.setText(printPc()+"");
    ...
    wire14.setText("4");
    wire14.setForeground(new Color(255, 86, 109));
...
//    wire15.setText((printPc()+4)+"");
    ...
    wire16.setForeground(Color.orange.darker());
...
//    wire19.setText((printPc()+4)+"");
   ...
   // wire22.setText("Byte Read");
    wire22.setForeground(Color.pink);
  ...
  //  wire32.setText("rt");
   ...
   //  wire35.setText("rt");
     ...
     wire36.setText("rd");
     wire36.setForeground(Color.CYAN);
